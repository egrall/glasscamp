...
var mongoose            = require('./libs/user').mongoose;
var UserModel           = require('./libs/user').UserModel;
var ClientModel         = require('./libs/client').ClientModel;
var AccessTokenModel    = require('./libs/token').AccessTokenModel;
var RefreshTokenModel   = require('./libs/token').RefreshTokenModel;
